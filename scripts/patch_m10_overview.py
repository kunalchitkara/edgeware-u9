#!/usr/bin/env python3
"""Integrate M10 results into overview and season stats in index.html."""
...
NEXT_MATCH = (
    ...
    '<div class="nminfo"><h3>Next Match · 26 Jul 2026</h3>'
    "<p>&#127968; Edgware vs Pinner &nbsp;&middot;&nbsp; Home &nbsp;&middot;&nbsp; "
    "Canons High School &nbsp;&middot;&nbsp; 09:00 / 10:00 AM</p></div></div>"
)

OVERVIEW_STATS = """  <div class="sgrid">
    <div class="sbox"><div class="v">10</div><div class="l">Played</div></div>
    <div class="sbox win"><div class="v">9</div><div class="l">Wins</div></div>
...
def main() -> None:
    ...
    html = html.replace(
        "Based on M2, M4, M5, M6, M7 &amp; M8 (M1, M3 &amp; M9 walkovers).",
        "Based on M2, M4, M5, M6, M7, M8 &amp; M10 (M1, M3 &amp; M9 walkovers).",
    )
    html = html.replace(
        "Based on 6 played matches (M2-M7 plus M8 vs Harefield). M1, M3 &amp; M9 walkovers.",
        "Based on 7 played matches (M2-M8 plus M10 vs H Manor). M1, M3 &amp; M9 walkovers.",
    )

    INDEX.write_text(html, encoding="utf-8")
    print(f"Updated M10 overview in {INDEX}")
    ...
    sps.ECC_NAMES = set(sps.ECC_NAMES) | {"Shay", "Riyan"}
    ...
    INDEX.write_text(html, encoding="utf-8")
    print("Regenerated season stats with M10")
